...
try:
 with sync_playwright() as p:
  ...
  page.locator('#metro-start').click();page.wait_for_function("document.querySelector('#metro-status').textContent.startsWith('Playing')");page.locator('#cadence-practice summary').click();page.wait_for_function("document.querySelector('#metro-stop').disabled");check('Closing practice stops audio',page.locator('#metro-status').inner_text()=='Stopped.')
