...
assert.match(html, /<video id="filmA" data-src="\/media\/run-development.mp4\?v=rd16"/);
assert.match(html, /<script defer src="\/js\/coaching-measurement.js\?v=20260916-single-runner"><\/script>/);
console.log('PASS: unique search/OG/Twitter tags, canonical, schema, original film with deferred loading/versioned measurement, JPEG 1200x630 and size.');
