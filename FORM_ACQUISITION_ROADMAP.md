...
Every dollar and every public surface should do one of two things:

- **speed up useful learning**, or
- **improve conversion of already-earned attention into qualified athletes**.

Do not optimize around clicks, likes, or cheap traffic in isolation.
...
## 4. Serious-runner cohort hypothesis

A potentially valuable layer is emerging around **curation, not access-for-sale**.
...
- money never buys admission to the cohort.

The eight-week relationship may function as a useful **observation / trust period** because Brice gets to see how an athlete trains, communicates, handles difficulty, and affects the people around them.

### Current performance proxy

For faster shared long runs / hard sessions, the present rough compatibility band is around:

- **sub-3:00 marathon**, or
- **sub-1:30 half marathon**

These are working pace proxies, **not permanent membership rules**. Selection should ultimately depend on whether someone can safely and usefully train with the group.

More important than a qualifying time:

- consistency;
- durability;
- ability to control effort;
- willingness to contribute rather than perform socially;
- appropriate long-run / workout pace compatibility;
- reliability;
- respect for the practice and other athletes.

Do **not** turn physique or body type into an admission criterion. The desired culture can favor strong, durable, well-rounded runners without making appearance a gate.

### Why this could matter

If it develops naturally, the cohort can create:

- better training partners for athletes who have outgrown generic run clubs;
- stronger long-run and workout environments;
- retention after an athlete no longer needs intensive coaching;
- referrals from people who deeply understand FORM;
- a tangible answer to the prospect asking, “where are the other serious runners?”;
- a differentiated reason to begin with FORM without needing to charge for community access.

### Important restraint

This is **a hypothesis, not a new public product**.

Do not launch a membership page, announce qualification standards, or promise permanent group sessions yet.

First accumulate several high-fit managed athletes and observe whether the network becomes useful without needing heavy scheduling, promotion, or management.

## 5. Immediate operating questions
