...
September 15 decision: Race Pace Durability is a paid 15-week plan with Weeks 1–4 open as the public preview and the complete plan priced at $79 one time. Moving beyond Week 4 routes to the purchase page. The old September 12 optional-support/free-full-plan model is retired. Live Stripe hosted checkout is now connected and the purchase page routes to the $79 one-time Payment Link. Paid delivery is still manual after checkout until authenticated/tokenized entitlement exists. Personal coaching retains its existing separate flow.
