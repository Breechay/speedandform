...
const wayfinding=`<nav class="site-wayfinding" aria-label="Explore FORM"><a href="/library">Library</a><a href="/plans/">Training plans</a><a href="/thursday">Run with us</a><a href="/#begin">Work with Brice</a></nav>`;
...
function searchForm(){return `<form class="discovery-search" id="discovery-search" role="search" action="/search" method="get"><label for="discovery-query">What would you like to understand?</label><div class="discovery-field"><input id="discovery-query" type="search" name="q" maxlength="180" placeholder="Try easy running, race pace, strength…" autocomplete="off"><button type="submit">Search</button></div></form>`;}
function header(){return `<a class="discovery-skip" href="#main">Skip to content</a><header class="discovery-wrap discovery-header"><a class="discovery-brand" href="/" aria-label="FORM home">FORM<span>.</span></a><nav class="discovery-nav" aria-label="Main"><a href="/library">Library</a><a href="/plans/">Training plans</a><a href="/thursday">Run with us</a><a href="/#begin">Work with Brice</a></nav></header>`;}
function footer(){return `<footer class="discovery-wrap discovery-footer"><p>Speed &amp; Form<br>Running with Brice. Miami + Remote.</p><nav aria-label="Footer"><a href="/labs/">Studies &amp; tools</a><a href="/form/">FORM app</a><a href="/forge-sculpt/">Breechay Sculpt</a><a href="/athlete/">Athlete sign in</a><a href="/privacy.html#website">Privacy</a></nav></footer>`;}
...
function build(){
 ...
 for(const file of navFiles){let h=read(file);if(['library.html','search.html','404.html'].includes(file)||h.includes('class="site-wayfinding"'))continue;
