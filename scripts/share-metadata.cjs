...
const PRESERVE = {
  ...
  'labs/speed-that-endures/index.html': '/og/speed-that-endures.png',
...
const ALTS = {
  ...
  '/og/speed-that-endures.png': 'FORM Speed That Endures study card: How much of the pace can you keep?',
