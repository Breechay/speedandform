# Paste this to a Claude browser agent

You are continuing **speedandform.com**, not starting a new site.

Read `docs/EXPERIENCE-BRIEF.md` and `docs/ASK-BRICE.md` before you design. Then open `index.html`.
...
- Plate 03 is the first question (*What are you trying to do?*). Film B continues. The still is canned. Hope lives at `/notes`, not on the review. The review is a receipt. Begin still opens at question one.
...
Ask Brice the questions in ASK-BRICE before writing new claims. Then prototype in this order: ticks → 02 text axis → type assembly on the 01→02 handoff. Phone / Chrome first. Use existing tokens and `--ease`.

If a change makes 01+first thesis+Begin no longer complete without extra swipes, delete it.
