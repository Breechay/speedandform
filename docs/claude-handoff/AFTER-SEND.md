...
Do not mention one. Do not write that $250 comes off the price. That is easy to offer and painful to walk back. If you want a credit later, say so then.

## Reply — yes

Write the first sentence yourself. That is the product. Everything else is logistics.
...
The honest no is required. Do not soften it into a maybe.

```
[Name] —

This is not the right eight weeks for you. [One sentence why.]

If that changes, write me.

Brice
```

Send from `briceikouebe@gmail.com`. The done screen already tells them to expect that.
