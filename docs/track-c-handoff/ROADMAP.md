...
- `[~]` **B5 · Dragon / weather.** Crop raised, right edge in, atmosphere mask, one ribbon cloud at `.22` multiply. Still not “there” as weather. Next lever is crop and quiet, not size, not a second cloud. *19 Aug*
