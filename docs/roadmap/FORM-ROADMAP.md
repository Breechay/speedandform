...
| HYROX typography | LIVE PR108; extended pass in release | Station distance/load rows and consistent guidance labels; calmer training hierarchy, readable week and library typography. No calculator or record changes. PR108: main `d99264707b152ac925c92ec14244285e8e33ae54`, Netlify `6aa7d1e7cf09b7000864b3bd`, published 10:52:36 UTC. Extended page-wide scale and responsive rules follow in this PR. Shared standard installed in web AGENTS and FORM-iOS PR19 (documentation only). |
