...
| --- | --- | --- |
| Homepage coaching flow | LIVE PR112 | Main `5210f38deef20affa483ef1487428ef5ebb42708`; Netlify `6aa8222b75fb510008166dfb`, published September 14 at 16:35:05 UTC via Git integration. Six-width overflow check and mocked intake/fallback checks pass; live selector and new copy verified. Physical-device and inbox-delivery checks remain open. See [homepage audit](../audits/HOME-COACHING-FLOW-AUDIT.md). |
