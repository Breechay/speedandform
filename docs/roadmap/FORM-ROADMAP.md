...
| HYROX editorial consolidation | RELEASE CANDIDATE | One hero navigation, merged racing doctrine, three primary metrics, station loads and standards, plain effort cues, first-three-weeks option, record-derived pair chart. Existing fields/bookmarks preserved; no record schema change. Release receipt follows in PR. |
