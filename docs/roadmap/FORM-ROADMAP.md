...
| --- | --- | --- |
| Homepage coaching flow | REFINEMENT READY | September 14: complimentary Miami assessment; weekly track coaching; four gym sessions plus strength programming in Run + Strength; distinct remote inquiry. Mocked pricing, attribution and failure/fallback checks pass. Production verification pending for this refinement; PR112 remains the preceding verified release. See [homepage audit](../audits/HOME-COACHING-FLOW-AUDIT.md). |
