...
| HYROX typography | RELEASE CANDIDATE | Station distance/load rows and consistent guidance labels; calmer training hierarchy, readable week and library typography. No calculator or record changes. Production/browser receipt in release PR. |
