...
**Conversion durability doctrine:** Simon's gap is not simply a late-race fade problem. His official 17:36 5K and 1:26:13 half show a common conversion problem: shorter-distance ability sits well above the sustainable half-marathon line. Block 01 attacks the opening half of that problem in parallel — Tuesday extends goal-half-pace continuity while Thursday raises the ceiling. If Gate 01 shows that the work is being absorbed, the next authored block should add longer threshold-duration work and begin placing selected race-pace work after prior mileage. That is the bridge from "more room above" to "more of the room available for 21.1 km." Keep the public study visually as two curves; treat threshold and late specific work as the conversion machinery between them.
