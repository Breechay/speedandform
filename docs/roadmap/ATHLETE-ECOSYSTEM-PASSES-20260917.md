...
| 4 | Remote strength athlete web experience and usable fallback | ACTIVE NEXT. Reconcile Adrian's actual existing web/Forge sources first; provide a usable read-only fallback without claiming native sync or manufacturing receipts. |
