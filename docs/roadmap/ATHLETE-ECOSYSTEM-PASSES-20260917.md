...
| 5 | Four-runner identity and assignment reconciliation | ACTIVE NEXT. Reconcile Anthony, Lisa, Hope and José against live athlete identity, assignment, authored versions, current calendar position and evidence history before changing any athlete-facing state. Preserve each plan and do not copy a demo assignment across athletes. |
| 6 | Console access/delivery overview and coach-owned preview | QUEUED. Not athlete impersonation. |
