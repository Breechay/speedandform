...
- Homepage `/` and `/mockupc` match (`rd43` / `snap43`): W1 tab, tell, weather drift. Race line parked. Live `/` is this plate. Specs: `docs/claude-handoff/INSTRUMENT-PLATE.md`, `SURFACE-AND-WEATHER.md`. Receipt + Zelle: `AFTER-SEND.md`.
