# Race Pace Durability — result-page draft

Status: **internal / result pending / do not merge to production yet**.

This composition intentionally borrows the visual system from `/labs/hyrox/`: deep green-black field, lime evidence accents, oversized Inter headlines, fixed mast, numbered editorial rails, one-pixel grids, restrained cards and no decorative imagery required for hierarchy.

## Locked baseline

Event: **Key Biscayne Half Marathon**
Date: **April 5, 2026**
Location shown by the official certificates: **Crandon Park**

- Hope Finnane — official net **1:40:24**, **7:39/mi**
  - https://triregistration.com/RunCertificate.php?runresultid=158498
...
Never replace a pending result with a forecast. The page can say what the method asked and what was observed during training, but the transformation headline is written only from verified results.

If both athletes break 1:30, a secondary post-race campaign may truthfully use a line such as `Two runners. 1:40 → sub-1:30.` If outcomes differ, publish the two outcomes separately rather than compressing them into a cleaner story.
